...
const UpdateLogisticsProvidersModel = ({
  isVisible,
  onCancel,
  onOk,
  form,
  ...
  useEffect(() => {
    if (isVisible && selectedProvider) {
      ...
      const formData = {
        ...selectedProvider,
        establishedYear: selectedProvider.establishedYear ? dayjs(selectedProvider.establishedYear) : null,
        lastAuditDate: selectedProvider.lastAuditDate ? dayjs(selectedProvider.lastAuditDate) : null
      };
...
export default UpdateLogisticsProvidersModel;
