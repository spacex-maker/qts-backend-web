...
const UpdateLogisticsRoutesModel = ({
  isVisible,
  onCancel,
  onOk,
  form,
      ...
      <Card title={`${typeName}服务`} size="small">
        <Space direction="vertical" size={12}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Form.Item name={`${type}Freight`} valuePropName="checked" noStyle>
              <Switch />
            </Form.Item>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span>跟踪服务</span>
            <Form.Item name={`${type}TrackingService`} valuePropName="checked" noStyle>
              <Switch />
            </Form.Item>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span>保险服务</span>
            <Form.Item name={`${type}Insurance`} valuePropName="checked" noStyle>
              <Switch />
            </Form.Item>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Space.Compact style={{ flex: 1 }}>
              <Form.Item name={[`${type}TransitTime`, 'value']} noStyle>
                <InputNumber 
                  min={1} 
                  max={365}
                  style={{ width: '100%' }}
              ...
              <Form.Item name={[`${type}TransitTime`, 'unit']} noStyle>
  ...
  return (
    <Modal
      ...
      width={1000}
    >
      <Form form={form} onFinish={handleUpdateRoute} layout="horizontal">
        <Card size="small">
          <Row gutter={24}>
            <Col span={12}>
              <Form.Item
        ...
        <Card size="small">
          <Row gutter={24}>
            <Col span={12}>
              <Form.Item label="环保选项" name="ecoFriendly" valuePropName="checked">
                <Switch />
              </Form.Item>
            </Col>
            <Col span={12}>
...
export default UpdateLogisticsRoutesModel; 